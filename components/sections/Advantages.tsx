    ...
    return (
        <section id="silhouettes" className="bg-[#F6F1E8] text-[#141414]">
            <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
                ...
                >
                    <p className="text-xs tracking-[0.32em] text-[#141414]/60">PARTNER ADVANTAGES</p>
                    ...
                    <div className="mt-10 grid gap-6 md:grid-cols-12">
                        <div className="md:col-span-4">
                            ...
                            <p className="mt-5 text-sm leading-7 text-[#2a2a2a]/80">
                                We help convert ideas into production-ready garments without compromising the aesthetic — and without
                                introducing avoidable cost, complexity, or risk.
                            </p>
                        </div>
                        ...
                        <div className="md:col-span-8">
                            <div className="grid gap-4 md:grid-cols-2">
                                {cards.map((c, i) => (
                                    ...
                                    >
                                        <div className="text-xs tracking-[0.32em] text-[#141414]/55">{c.title.toUpperCase()}</div>
                                        <div className="mt-3 text-lg">{c.title}</div>
                                        <div className="mt-2 text-sm leading-7 text-[#2a2a2a]/75">{c.subtitle}</div>
